export const commonEn = {
  ...
  home: {
    ...
    subtitle: "Privacy-focused tools running entirely in your browser",
  ...
  toolList: {
    ...
    "url-decoder": {
      name: "URL Decoder",
      description: "Decode URLs and query parameters"
    },
    "html-encoder": {
    ...
    "data-size-converter": {
      ...
      description: "Convert data sizes between bytes, KB, MB, GB, and TB"
    },
