...
import { convertJsonToYaml } from '@/utils/converters/yamlJson'
...
export default function JsonToYamlConverter() {
  ...
  const loadExample = () => {
    setInput(t('tools.jsonToYaml.example'))
    setError(null)
  }
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">
          {t('tools.jsonToYaml.title')}
        </h1>
        <p className="mt-2 text-gray-600">
          {t('tools.jsonToYaml.description')}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <textarea
            ...
            placeholder={t('tools.jsonToYaml.placeholder')}
          ...
          >
            ...
            {t('tools.jsonToYaml.convertButton')}
          </button>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <label className="block text-sm font-medium text-gray-700">
              {t('tools.jsonToYaml.outputLabel')}
            </label>
